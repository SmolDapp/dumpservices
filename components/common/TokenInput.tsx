	...
	return (
		<div className={'grid w-full grid-cols-12 gap-x-2'}>
			...
			<label className={'grow-1 col-span-7 flex h-10 w-full'}>
				<div ref={inputRef} className={cl('flex w-full items-center justify-between rounded-md p-2 border border-neutral-200 cursor-text', isDisabled ? 'bg-neutral-200' : 'bg-neutral-0')}>
					<input
						...
						onFocus={onFocus} />
					<div ref={scope} className={'ml-2 flex flex-row items-center space-x-2'}>
						...
						<button
							...
							className={cl('px-2 py-1 text-xs rounded-md border border-neutral-900 transition-colors bg-neutral-900 text-neutral-0', 'opacity-0 pointer-events-none')}>
							{'Max'}
						</button>
					</div>
				</div>
